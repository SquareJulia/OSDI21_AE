...
def gencode(BA,outfile,C_dim,A_blocks,C_blocks,GY,name=None):
    ...
    os.system("nvcc -arch=sm_70 -I build/include -L build/lib -w -O3 -ptx -o " + temp_ptx_file_name + " " + temp_cu_file_name + " --std=c++11 --compiler-options=\"-fsingle-precision-constant\" -lcnpy -lz")
    os.sync()
